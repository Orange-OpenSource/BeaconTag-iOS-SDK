...
extern NSString *const kBeaconTagSDKErrorDomain;

typedef NS_ENUM(NSInteger, BeaconTagError) {
    kBeaconTagUUIDNotMatchedError
};

NSString *descriptionForError(BeaconTagError errorCode);